...
### 2. 📊 ¿Qué es una tabla en base de datos? 🟡
...
> 🎯 Las primary keys garantizan identidad única. ¡Como tener identificación única!
...
> 💡 Las foreign keys crean relaciones entre tablas. ¡Como tener conexiones de data!

### 5. 🔄 ¿Qué es un JOIN en SQL? 🟡
...
> 📘 Los JOINs permiten queries across múltiples tablas. ¡Como tener combinación de data!
...
C) ⚙️ Configurar settings de DELETE
...
> 💡 HAVING filtra grupos agregados. ¡Como tener filtrado de grupos!

### 14. 📊 ¿Qué es una aggregate function? 🟡
...
> 📘 Las aggregate functions incluyen SUM, AVG, COUNT. ¡Como tener cálculos de data!
...
> 🎯 Los subqueries permiten queries complejas. ¡Como tener queries anidadas!

### 16. 📝 ¿Qué es un view en base de datos? 🟡
...
> 💡 Los views simplifican acceso a data compleja. ¡Como tener vistas virtuales!
...
> 📘 Los stored procedures encapsulan lógica de negocio. ¡Como tener procedimientos almacenados!

### 18. 📊 ¿Qué es un trigger en base de datos? 🟡

A) 📊 Código que ejecuta automáticamente

B) 🔧 Configuración de trigger
...
> 🎯 Los triggers responden a cambios de data. ¡Como tener automatización!

### 19. 🔧 ¿Qué es un index en base de datos? 🟡
...
> 💡 Los indexes mejoran performance de queries. ¡Como tener búsqueda rápida!

### 20. 📝 ¿Qué es el schema de base de datos? 🟡
...
> 📘 El schema define organización de data. ¡Como tener blueprint de database!

### 21. 🔄 ¿Qué es una transacción de base de datos? 🟡
...
> 🎯 Las transacciones garantizan consistencia. ¡Como tener atomicidad!